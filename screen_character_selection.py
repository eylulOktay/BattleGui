...
class Screen_CharacterSelection (tkinter.Frame):
    ...
    def create_widgets (self):
        ...
        for i in range (self.roster.get_number_of_characters()):
            ...
            tk.Radiobutton (self, text= character.name, variable = self.character_index, value = "what").grid(row = i+1,column = 0, sticky = W) 
        ...
        self.name = name
        tk.Radiobutton (self, text= character.name, variable = self.character_index, value = "what").grid(row = 2,column = ) 
